    ...
    return (
      <div className='main-footer'>
        <div
          style={{
            minHeight: "90vh",
            backgroundImage: `url("https://images.pexels.com/photos/292426/pexels-photo-292426.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260")`,
          ...
          <div
            ...
            <div
              ...
              <Container className='footer-middle' style={{ color: "#fcf9ed" }}>
                <Row className='footer-middle-row'>
                  <Col sm={12} md={6} xl={3}>
                    <h4>Messages</h4>
                    <ul className='list-unstyled'>
                      ...
                      <li>
                        <p
                          className='bottled-message-text'
                  ...
                  <Col sm={12} md={6} xl={3}>
                    ...
                    <ul className='list-unstyled messages-from-bottle'>
                  ...
                  <Col sm={12} md={6} xl={3}>
                    <h4 className='latest-messages'>Latest Messages</h4>
                    <ul
                      className='list-unstyled footer-messages'
                      style={{
                        display: "flex",
                        flexDirection: "row",
                        flexWrap: "wrap",
                      ...
                      <li style={{ flexBasis: "33%" }}>
                        <Image
                          ...
                          style={{ height: 80, width: 80, marginBottom: 3 }}
                        />
                      </li>
                      <li style={{ flexBasis: "33%" }}>
                        <Image
